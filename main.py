...
@app.route('/')
def index():
    return '<p>Здесь вы можете посмотреть случайный факт о технологических зависимостей</p>''<a href="/random_fact">Посмотреть случайный факт!</a>''<a href="/coin">Подбросить монетку!</a>'
    

@app.route("/random_fact")
def random_fact():
    random_fact = random.choice(facts)
    return f'<h1>{random_fact}</h1>'
